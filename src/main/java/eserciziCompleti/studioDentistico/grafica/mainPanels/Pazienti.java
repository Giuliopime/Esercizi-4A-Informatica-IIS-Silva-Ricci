...
import eserciziCompleti.studioDentistico.grafica.dialogs.DialogFiltriPazienti;
import eserciziCompleti.studioDentistico.grafica.dialogs.DialogOrdinaPazienti;
...
public class Pazienti implements FocusListener {
    ...
    private void initGrafica() {
        ...
        btnOrdina.addActionListener(e -> {
            ...
            GestoreGrafica.getInstance().changePanel(TipoPanel.PAZIENTI, new String[]{ricerca});
        });
    ...
    private void ricerca() {
        ...
        GestoreGrafica.getInstance().changePanel(TipoPanel.PAZIENTI, new String[]{query});
    }
