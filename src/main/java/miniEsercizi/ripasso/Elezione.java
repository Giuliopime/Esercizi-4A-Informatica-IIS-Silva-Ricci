    ...
    public void visualizzaScheda() {
        ...
        do {
            try {
                ...
                if (indiceCoalizione < 0)
                    JOptionPane.showMessageDialog(null, "Coalizione non trovata, reinserirne il nome.");
            } catch (Exception e) {
        ...
        do {
            try {
                ...
                if (indiceCandidato < 0)
                    JOptionPane.showMessageDialog(null, "Candidato non trovato nella coalizione \"" + scheda[indiceCoalizione].getNome() + "\", reinserirne il cognome.");
            } catch (Exception e) {
